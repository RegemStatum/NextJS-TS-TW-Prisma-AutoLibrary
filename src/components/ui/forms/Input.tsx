  ...
  return (
    <div>
      ...
      <input
        ...
        id={name}
        name={name}
        className=" block w-full p-2 text-sm bg-gray-50 border border-gray-300 text-gray-900  rounded-sm placeholder-slate-400 focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500
